...
final class ProcessoController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        $query = Processo::query()->with(['dfd', 'etp', 'mapaRisco', 'pesquisaPreco', 'tr', 'edital', 'aprovacaoFinal'])->latest();
    ...
    public function show(int $id): JsonResponse
    {
        $processo = Processo::with([
            ...
            'pesquisaPreco.elaborador', 'pesquisaPreco.aprovador', 'pesquisaPreco.versoes.usuario',
            'tr.elaborador', 'tr.aprovador', 'tr.versoes.usuario',
            'edital.elaborador', 'edital.aprovador', 'edital.versoes.usuario',
            'aprovacaoFinal.solicitante', 'aprovacaoFinal.aprovador',
            'criador',
        ])->findOrFail($id);
