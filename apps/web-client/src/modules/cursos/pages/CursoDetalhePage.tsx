...
import { ArrowLeft, BookOpen, ImagePlus, Pencil, Plus, Trash2 } from 'lucide-react';
import { ActionsMenu, Button, Card, type ActionsMenuItem } from '@sysgov/ui';
import { ConfirmDialog, EmptyState, PageHeader, ScreenState, StatusChip } from '@/components/ui';
...
import { MODALIDADE, STATUS_CURSO, STATUS_TURMA, TIPO_CURSO, formatarCargaHoraria, formatarData } from '../utils/formatos';
