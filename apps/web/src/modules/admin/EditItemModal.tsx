      ...
      <div className="mod-card w-full max-w-lg shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="p-4 space-y-4">
          ...
          <div className="flex justify-end gap-2 pt-2">
            ...
            <button type="submit" className="px-4 py-2 text-xs font-semibold bg-primary hover:bg-primary/90 text-primary-foreground rounded-lg shadow-md"><Save className="inline mr-2" size={12}/>Salvar Alterações</button>
          </div>
        </form>
      </div>
    </div>
